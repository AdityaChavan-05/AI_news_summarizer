BRANCH_MAPPINGS = {
    ...
    "Mechanical": "mechanical engineering OR robotics OR manufacturing",
    "Civil": "civil engineering OR construction OR infrastructure",
    "Electrical": "electrical engineering OR power systems OR renewable energy",
}